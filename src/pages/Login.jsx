      ...
      <div className="w-full max-w-md bg-surface/70 backdrop-blur-md rounded-2xl shadow-lg border border-outline-variant/10 p-8 animate-slide-up">
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 bg-primary-fixed rounded-2xl flex items-center justify-center text-primary shadow-sm">
            <span className="material-symbols-outlined text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>image</span>
          </div>
        </div>
        <h2 className="font-headline-md text-headline-md font-bold text-center text-on-surface mb-2">Welcome Back</h2>
        <p className="font-body-md text-body-md text-center text-on-surface-variant mb-8">Sign in to MediaShrink & Hide</p>
